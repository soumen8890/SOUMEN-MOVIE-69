...
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/bf857432fc26bfe67469b-2856bf2ac968aab6ea.gif")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/c76e2a3de54bdedbd3d9e-5cf61dfddb276136cd.jpg'))
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002389404459'))  # Notification of those who verify will be sent to your channel
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001910963939')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001910963939')  # Request channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/c76e2a3de54bdedbd3d9e-5cf61dfddb276136cd.jpg')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://xenam92415:MUI5ki9Lyqsuu26M@cluster0.e840h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Soumen_files')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1001954153980'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/downloader789')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/downloader789')  # Tutorial video link for opening shortlink website
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/movieguru9980')
OWNERID = int(os.environ.get('OWNERID', '6233910543'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/soumensupport')  # Support group link (make sure bot is admin)
